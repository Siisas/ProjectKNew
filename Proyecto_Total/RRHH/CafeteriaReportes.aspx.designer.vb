...
Partial Public Class CafeteriaReportes
    ...
    '''<summary>
    '''Control btn_ConsultarVentasFecha.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Drl_NombreProductoStock As Global.System.Web.UI.WebControls.DropDownList
    
    '''<summary>
    '''Control Btn_ConsultarDisProductos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents Btn_ConsultarDisProductos As Global.System.Web.UI.WebControls.Button
