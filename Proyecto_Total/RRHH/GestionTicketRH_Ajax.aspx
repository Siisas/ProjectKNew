<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GestionTicketRH_Ajax.aspx.vb" Inherits="digitacion.GestionTicketRH_Ajax" %>
                ...
                <ContentTemplate>
                    ...
                    <section>
                        ...
                        <div class="Form">
                            ...
                            <div class="Cell-Form">
                                <div class="input-group">
                                    <div class="input-group-addon">Fecha Ingreso Técnico</div>
                                    <asp:TextBox ID="TxtFechaEstado" CssClass="form-control Fecha" runat="server"></asp:TextBox>
                                </div>         
                                  <div class="input-group">
