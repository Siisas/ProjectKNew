Public Class CafeteriaReportes
    ...
    Public Sub ConsultarStock()
        Drl_NombreProductoStock.DataSource = ObjProductosCafeteria.CargarDatosDDlComprarProductos
    ...
    Protected Sub Btn_ConsultarDisProductos_Click(sender As Object, e As EventArgs) Handles Btn_ConsultarDisProductos.Click
        If Drl_NombreProductoStock.SelectedValue = "-Seleccione-" Then
            Lbl_Mensaje.Text = "Por favor seleccione un producto"
        Else
